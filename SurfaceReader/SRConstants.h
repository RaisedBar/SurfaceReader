...
const std::wstring strLogExtension = L".log";
...
const std::wstring strVirtualInSuffix = L" display";
const std::wstring strVirtualOutSuffix = L" hardware";
...
const std::wstring strHardwareInError = L"Hardware input port: ";
const std::wstring strHardwareOutError = L"Hardware output port: ";
const std::wstring strDisplayInError = L"Display input port: ";
const std::wstring strDisplayOutError = L"Display output port: ";
const std::wstring strPortError = L"The following ports could not be opened for the surface - ";
...
const std::wstring wstrDoubleQuotes = L"\"";
	...
	const std::wstring wstrDash = L"-";
		...
		const std::wstring strSpacedColon = L":  ";
...
const std::wstring strNewLine = L"\n";
